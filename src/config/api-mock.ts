...
export class ApiMock implements Datasource {
    ...
    constructor() {
        ...
        this.issues.push(new Document("author", "userId", "Devops", new Date(), new Date(), "Some question", ["c", "b"], 5, "f06f2f60-a97b-4675-baf7-762aecc6176d", "some/desc2", "Donec ornare dui metus, ut tincidunt erat bibendum in. Pellentesque egestas leo nibh, consequat vulputate leo porttitor sed.", true));
    ...
    async incrementViews(id: string): Promise<void> {
        const docIndex = this.issues.findIndex(doc => doc.id == id)
